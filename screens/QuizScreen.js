                ...
                <Pressable onPress={()=>selectedAnswerIndex===null && setSelectedAnswerIndex(index)} 
                    style={selectedAnswerIndex === index &&
                        index === currentQuestion.correctAnswerIndex
                            ?{flexDirection:"row",backgroundColor:"green" ,alignItems:"center",borderWidth:0.5,borderColor:"#00FFFF",marginVertical:10,borderRadius:20}:
...
{selectedAnswerIndex === index &&
            ...
            />
                ...
                />
                    ...
                    <Text style={{borderColor:"#00FFFF",textAlign:"center",width:40,height:40,borderRadius:20,padding:10,borderWidth:0.5}}>
                        {item.options}
                    </Text>
              )}
